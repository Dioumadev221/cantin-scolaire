...
class _MenusScreenState extends ConsumerState<MenusScreen> {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      Expanded(child: StreamBuilder<QuerySnapshot>(
        stream: _firestore.collection('menus')
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          GestureDetector(
            ...
            child: Row(children: [
              const Text('Menus', style: TextStyle(color: Colors.white,
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          _buildWeekBtn('‹', () => setState(() { _weekOffset--; _selectedDay = 0; })),
          Column(children: [
            Text(weekLabel, style: const TextStyle(color: Colors.white,
                fontSize: 13, fontWeight: FontWeight.w600)),
            Text(
              _weekOffset == 0 ? 'Cette semaine'
                  : _weekOffset == -1 ? 'Semaine passée'
                  : _weekOffset == 1 ? 'Semaine prochaine'
                  : _weekOffset < 0 ? 'Il y a ${_weekOffset.abs()} semaines'
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (_, scrollCtrl) => Column(children: [
          ...
          Expanded(child: StreamBuilder<List<QueryDocumentSnapshot>>(
  ...
  Widget _buildAvatarMenu() {
    return PopupMenuButton<String>(
      ...
      itemBuilder: (context) => [
        PopupMenuItem(value: 'profil', height: 48,
          child: Row(children: [
        ...
        PopupMenuItem(value: 'deconnexion', height: 48,
          child: Row(children: [
            Container(width: 32, height: 32,
        ...
        return Expanded(child: GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: isActive ? const Color(0xFFFF6B35)
                    : isToday ? const Color(0xFFFF6B35)
                    : const Color(0xFFEDEDED),
                width: 1.5),
            ),
            child: Column(children: [
              Text(_days[i], style: TextStyle(fontSize: 9,
                  fontWeight: FontWeight.w600,
                  color: isActive ? Colors.white70
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: const Row(mainAxisAlignment: MainAxisAlignment.center,
              ...
              SizedBox(width: 8),
              Text('Créer le menu du jour', style: TextStyle(
  ...
  Widget _buildMenuContent(String menuId, Map<String, dynamic> menuData) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        GestureDetector(
          onTap: _isPastDay ? null : () => _firestore
              .collection('menus').doc(menuId).update({'actif': !actif}),
          child: Container(
            width: double.infinity,
            padding: const EdgeInsets.symmetric(vertical: 13),
            decoration: BoxDecoration(
              color: actif
                  ? const Color(0xFFD1FAE5) : const Color(0xFFF3F4F6),
              borderRadius: BorderRadius.circular(14),
              border: Border.all(color: actif
                  ? const Color(0xFF22C55E) : const Color(0xFFEDEDED)),
            ),
  ...
  Widget _buildSlot(String menuId, String emoji, String titre,
      String field, List<String> platsIds, String categorie) {
    return Container(
              ...
              Row(children: [
                ...
                if (!disponible)
                  Container(
                    ...
                    child: const Text('Indispo', style: TextStyle(
  ...
  void _showAddPlatToSlot(String menuId, String field,
      List<String> existing, String categorie) {
    showModalBottomSheet(
      context: context, isScrollControlled: true,
      backgroundColor: Colors.white,
      shape: const RoundedRectangleBorder(
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (_, scrollCtrl) => StreamBuilder<QuerySnapshot>(
          stream: _firestore.collection('plats')
              ...
              if (docs.isEmpty)
                ...
                Expanded(child: ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return GestureDetector(
                      onTap: () async {
                        await _firestore.collection('menus')
                            .doc(menuId).update({
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          ...
                          Expanded(child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                            Text(data['nom'] ?? '', style: const TextStyle(
                                fontSize: 14, fontWeight: FontWeight.w700)),
                            Text('${data['prix']} FCFA',
                                style: const TextStyle(
  ...
  void _createMenu() {
    _firestore.collection('menus').add({
      'date': _selectedDateStr, 'actif': true,
